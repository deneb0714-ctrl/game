...
class BossScene extends Phaser.Scene {
  ...
  createHUD() {
    this.hpText = this.add.text(30, 20, '', { fontFamily: '"Press Start 2P"', fontSize: '32px', color: '#FF4B6E' }).setDepth(100);
    this.energyText = this.add.text(30, 60, '', { fontFamily: '"Press Start 2P"', fontSize: '24px', color: '#4FD1FF' }).setDepth(100);
  ...
  updateHUD() {
    ...
    if (this.isEnergyHighlighted) {
      ...
      this.energyBarOutline.strokeRect(26, 96, 408, 40);
    } else {
      this.energyBarOutline.lineStyle(2, 0x4FD1FF, 0.6);
      this.energyBarOutline.strokeRect(30, 100, 400, 32);
    }
