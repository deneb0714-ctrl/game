...
class BossScene extends Phaser.Scene {
  ...
  playDemonLordIntro(onComplete) {
    ...
    this.demonImage = this.add.image(1920 - 500, 1080 / 2, 'demon_lord_normal').setAlpha(0).setDepth(90);
      ...
      this.tweens.add({
        ...
        onComplete: () => {
          ...
          if (key === 'boss1') {
            ...
            this.demonImage = this.add.image(1920 - 500, 1080 / 2, 'demon_lord_dying').setAlpha(0).setDepth(90);
            var dScale = 1100 / this.demonImage.width;
            this.demonImage.setScale(dScale);
            this.demonImage.setY(100 + (this.demonImage.height * dScale) / 2);
