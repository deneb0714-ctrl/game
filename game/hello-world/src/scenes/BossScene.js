...
class BossScene extends Phaser.Scene {
  ...
  getBossConfig(key) {
    var configs = {
      boss1: {
        texture: 'boss1_combat', name: '幹部1 – 筋肉', hp: 100, scale: 0.15,
        intro: '「貴様が博士の人形か。\nこの俺の拳で叩き潰してやる！」',
        defeat: '「馬鹿な…この俺が…！」',
        choices: [
      ...
      boss2: {
        texture: 'boss2_battle_anim', name: '幹部2 – 戦闘狂', hp: 150, scale: 0.3,
        intro: '「ヒャハハ！ 踊れ踊れぇ！！\n俺の双銃から逃げられるかなぁ！？」',
      ...
      boss3_twins: {
        texture: 'boss3_battle_anim', name: '男（兄）', hp: 200, scale: 0.25,
        texture2: 'boss3_sister', name2: '女（妹）', hp2: 200, scale2: 3,
        // Intro and defeat are handled custom via playTwinsIntro and post-battle logic
      },
      demon_lord: {
        texture: 'demon_stand_combat', name: '魔王 – ヴェリタス', hp: 400, scale: 0.5,
        intro: '「…来たか、博士の人形よ。\nお前に真実を伝えなければならない。」',
        defeat: '「聞いてくれ。博士こそが…この世界を壊そうとしている。\n俺は…それを止めたかっただけだ。」',
        choices: []
      },
      doctor: {
        texture: 'doctor_normal', name: '博士', hp: 600, scale: 0.5,
