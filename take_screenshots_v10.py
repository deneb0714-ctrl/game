...
async def main():
    async with async_playwright() as p:
        ...
        await page.evaluate("""
            ...
            window.killBoss = () => {
                if (window.__GAME && window.__GAME.scene.scenes[4].sys.isActive()) {
                    ...
                    window.MOT.flags.kills = 0;
                    window.MOT.flags.killedBoss1 = false;
                    window.MOT.flags.killedBoss2 = false;
                    window.MOT.flags.killedTwins = false;
                    window.MOT.flags.killingIntent = 100;
                    window.MOT.flags.dollPoints = 0;
        ...
        await page.screenshot(path=r'C:\Users\deneb\.gemini\antigravity\brain\dae176a6-e36f-4177-baf3-6662c090b0ab\screenshot_lab_freedom_v10.png')
        ...
        await page.screenshot(path=r'C:\Users\deneb\.gemini\antigravity\brain\dae176a6-e36f-4177-baf3-6662c090b0ab\screenshot_true_demon_lord_v10.png')
